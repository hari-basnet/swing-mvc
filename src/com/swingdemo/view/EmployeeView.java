...
public class EmployeeView extends JFrame {
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(563, 11, 551, 703);
	...
	private JButton getSaveButton() {
		if (saveButton == null) {
			...
			saveButton.setBounds(153, 518, 89, 23);
		}
		return saveButton;
	}
	private JButton getEditButton() {
		if (editButton == null) {
			...
			editButton.setBounds(153, 566, 89, 23);
		}
		return editButton;
	}
	private JButton getDeleteButton() {
		if (deleteButton == null) {
			...
			deleteButton.setBounds(153, 618, 89, 23);
		}
		return deleteButton;
	}
	private JButton getClearButton() {
		if (clearButton == null) {
			...
			clearButton.setBounds(153, 668, 89, 23);
		}
		return clearButton;
	}
